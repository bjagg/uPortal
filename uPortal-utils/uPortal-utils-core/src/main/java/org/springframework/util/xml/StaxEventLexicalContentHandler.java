...
/** */
public class StaxEventLexicalContentHandler extends StaxEventHandler
        implements LexicalHandler {
    public static final String EMPTY_SYSTEM_IDENTIFIER = "EMPTY";
    public static final String EMPTY_SYSTEM_ID_HTML_DOCTYPE_TO_REPLACE = "<!DOCTYPE html SYSTEM \"" + EMPTY_SYSTEM_IDENTIFIER + "\">";
    ...
    protected void dtdInternal(String dtd) throws XMLStreamException {
        ...
        String dtdToUse;
        if (EMPTY_SYSTEM_ID_HTML_DOCTYPE_TO_REPLACE.equals(dtd)) {
